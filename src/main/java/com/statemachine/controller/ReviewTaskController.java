...
public class ReviewTaskController {
    ...
    public ResponseEntity<TaskReviewResponse> addReviewer(@RequestBody TaskReviewerRequest request) {
        try {
            ...
            newReviewer.put("name", request.getReviewerName());
            newReviewer.put("email", request.getReviewerEmail());
            newReviewer.put("id", request.getReviewerId());
    ...
    private void addToContext(Map<String, Object> map, Map<String, Object> item, String key) {
        ...
        if (map.containsKey(key)) {
            ...
            List<Map<String, Object>> existingReviewers = (List<Map<String, Object>>) map
                    .get(key);
    ...
    public ResponseEntity<TaskReviewResponse> closeReview(@PathVariable String taskId) {
        TaskReviewerRequest request = new TaskReviewerRequest(taskId, null, null, null);
    ...
    public ResponseEntity<TaskReviewResponse> startIntegration(@PathVariable String taskId) {
        ...
        return executeTask(request, "o_t4", "owner", null);
    }
    ...
    public ResponseEntity<TaskReviewResponse> cancelIntegration(@PathVariable String taskId) {
        ...
        return executeTask(request, "o_t5", "owner", null);
    }
    ...
    public ResponseEntity<TaskReviewResponse> finishIntegration(@PathVariable String taskId) {
        ...
        return executeTask(request, "o_t6", "owner", null);
    }
    ...
    public ResponseEntity<List<Transition>> getAvailableTransitions(
        ...
        try {
            MachineEntity machine = machineService.getMachineByObject(taskId,
                    MachineEntity.ManagedObjectType.REVIEW_TASK.toString())
                    .orElseThrow(() -> new IllegalArgumentException("Task not found"));
     ...
     * @return
     */
    private ResponseEntity<TaskReviewResponse> executeTask(TaskReviewerRequest request, String transitionId,
            String role,
